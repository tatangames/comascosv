        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Imagen 360</li>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/propiedadimagen360/tabla') }}/" + idpropiedad;
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post('/admin/propiedadimagen360/registrar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function solicitarBorrar(idfila){
            ...
            axios.post('/admin/propiedadimagen360/borrar',{
                'id': idfila
            })
                .then((response) => {
                    closeLoading();
