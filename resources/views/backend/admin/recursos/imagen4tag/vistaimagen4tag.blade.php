        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Propiedad Etiqueta Imagen</li>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <p>Recomendación no superar: 256 x 256 px</p>
                                        </div>
                                        <br>
                                        <div class="col-md-10">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/imagen4tag/tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post('/admin/imagen4tag/registrar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacionEditar(id){
            ...
            axios.post('/admin/imagen4tag/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/imagen4tag/actualizar', formData, {
            })
                .then((response) => {
                    closeLoading();
