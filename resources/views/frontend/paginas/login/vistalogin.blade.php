...
@include("frontend.menu.body.bodylogin")
                ...
                <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                    <div class="text w-100">
                        ...
                        <a href="https://wa.me/50372068714" class="btn btn-white btn-outline-white">
                            <img src="{{ asset('images/logowasap.png') }}" width="35px" height="35px"
                                 alt="Descripción del logo"> 7206-8714</a>
                    </div>
                </div>
                <div class="login-wrap p-4 p-lg-5">
                    ...
                    <form action="#" class="signin-form">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="usuario" class="form-control" maxlength="100" placeholder="usuario"
                                   required>
                        </div>
                        <div class="form-group mb-3">
